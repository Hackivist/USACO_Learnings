...
public class crypt1 {
	...
	public static boolean checkValidity(int n,int l)
	{
		int len=0;
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i=100;i<1000;i++)
		{
			for(int j=10;j<99;j++)
			{
				...
				if(checkValidity(i,3)&&checkValidity(j,2))
				{


					res1 =  checkValidity((j%10)*i,3);
					res2 = checkValidity((j/10)*i,3);
					res3 = checkValidity(i*j,4);
