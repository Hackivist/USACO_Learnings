...
public class namenum {
	...
	public static void getNameNum(String input,String name,int index,int len)
	{
		if(name.length()==len){
		...
		if(res==null)
		{
			...
			{
				getNameNum(input, name+Character.toString(charset[i]),index+1, len);
